...
export default class MyPhotos extends Component {
    ...
    putOnSale = async (e) => {
        ...
        const photoId = e.target.value; /// [Note]: PhotoID is always 1. Because each photoNFT is unique.
                                ...
                                {currentAccount == photo.ownerAddress ? (
                                    ...
                                    >
                                        <Image
                                            ...
                                            maxWidth="100%"
                                            src={
                                                // `https://ipfs.io/ipfs/${photo.ipfsHashOfPhoto}`
                                                `http://localhost:8080/ipfs/${photo.ipfsHashOfPhoto}` //for local test
                                            }
                                        />
                                        ...
                                        <p>Photo Name: {photo.photoName}</p>
                                        ...
                                        {photo.status == "1" ? ( // this means "Cancelled"
                                            <Button
                                                size={"medium"}
                                                width={1}
                                                value={photo.photoId}
